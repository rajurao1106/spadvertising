    ...
    const valuecards = [
        {
            ...
            image: execution,
            title: 'Execution',
            description: 'We focus on delivering results with precision, ensuring timely, high-quality execution that meets client needs and expectations.',
        },
        {
            id: 2,
            image: Accountability,
            title: 'Accountability',
            description: 'We embrace responsibility for our actions, maintaining transparency and trust, ensuring high ethical standards in all our endeavors.',
        },
        {
            id: 3,
            image: growth,
            title: 'Growth',
            description: 'We value continuous learning, fostering innovation and development to help individuals and the organization reach their full potential.',
        },
        {
            id: 4,
            image: teamwork,
            title: 'Teamwork',
            description: 'We prioritize collaboration, leveraging diverse strengths and perspectives to achieve common goals and foster a supportive work environment.',
        },
