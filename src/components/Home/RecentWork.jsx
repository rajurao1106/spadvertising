  ...
  function SamplePrevArrow(props) {
    ...
    return (
      <div className="slide">
        ...
        <p>Discover our latest projects and innovative solutions that showcase creativity, excellence, and forward-thinking ideas.</p>
        
        </div>
        <Slider {...settings} className='slide-con'>
        <div>
        <img src={showcase1} alt="Mobile Hoarding" />
        </div>
        <div>
        <img src={showcase2} alt="Pole Kiosk" />
        </div>
        <div>
        <img src={showcase3} alt="Outdoor Campaign" />
        </div>
        <div>
        <img src={showcase4} alt="Mobile Hoarding" />
        </div>
        <div>
        <img src={showcase5} alt="Inshop-Branding" />
        </div>
        <div>
        <img src={showcase6} alt="Mobile Hoarding" />
        </div>
